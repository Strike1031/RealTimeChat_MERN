...
const MessagesView = ({
  ...
  return (
    <div
      className={`chatpageDiv chatpageView messagesView col text-light mx-0 mx-md-1 ${selectedChat ? "d-flex" : "d-none d-md-flex"
    ...
    >
      {selectedChat ? (
        <>
          ...
          />
          <section
            className={`messagesBody position-relative ${downloadingFileId || loadingMediaId ? "pe-none" : "pe-auto"
          ...
          >
            ...
            <div className="messages rounded-3 d-flex flex-column">
              <div
                ...
                className={`msgArea overflow-auto ${fileAttached && !msgEditMode ? "d-none" : "d-flex"
                  } flex-column-reverse`}
              >
            ...
            {/* New Message Input */}
            <div
              className={`msgInputDiv d-flex position-absolute ${msgEditMode || sending ? "pe-none" : "pe-auto"
                }`}
            >
              <span
              ...
              <div
                ...
                ref={msgContent}
                className={`msgInput ${fileAttached && !msgEditMode ? "addCaption" : ""
